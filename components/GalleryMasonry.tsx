    ...
    <section className="py-20 md:py-24">
      <div className="container mx-auto max-w-7xl px-4">
        ...
        {selectedImage && (
          ...
          >
            <Image src={selectedImage.url} alt={selectedImage.alt} width={1400} height={1000} unoptimized className="max-h-[85vh] max-w-[90vw] rounded-lg object-contain" />
          </div>
        )}
      </div>
    </section>
